...
import common
import dialogtightvncui
import logging

class dialogTightVNCUI(QtWidgets.QDialog, dialogtightvncui.Ui_DialogTightVNC):
    ...
    def __init__(self, name, configfile):
        ...
        self.setWindowTitle(common.getRessource("TightVNCViewerDialogTitle"))
        ...
        common.fillComboBox(self, "TightVNCViewerColorLevel", self.vncInputColor)
        ...
        if self.connectionname != "":
            ...
            self.vncInputName.setText(connection["name"])
    ...
    def parameterVNC(self, connectionname, values):
        ...
        if values["password"] != "":
            parameters = parameters + " " + common.getRessource("TightVNCViewerPassword") + " " + common.getPasswordFile(connectionname)
        if values["resolution"] == "FullScreen":
            parameters = parameters + " " + common.getRessource("TightVNCViewerFullScreen")
        else:
            parameters = parameters + " " + common.getRessource("TightVNCViewerScreen") + " " + values["resolution"]
        if values["color"] == "FullColor":
            parameters = parameters + " " + common.getRessource("TightVNCViewerFullColor")
        else:
            parameters = parameters + " " + common.getRessource("TightVNCViewerColor") + " " + values["color"]
        if values["parameter"] != "":
