...
class Ui_DialogRealVNC(object):
    def setupUi(self, DialogRealVNC):
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(10, 30, 631, 431))
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 470, 621, 31))
        ...
        DialogRealVNC.setTabOrder(self.vncInputName, self.vncInputAddress)
        DialogRealVNC.setTabOrder(self.vncInputAddress, self.vncInputPort)
        DialogRealVNC.setTabOrder(self.vncInputPort, self.vncInputPassword)
        DialogRealVNC.setTabOrder(self.vncInputPassword, self.vncInputResolution)
        DialogRealVNC.setTabOrder(self.vncInputResolution, self.vncInputColor)
        DialogRealVNC.setTabOrder(self.vncInputColor, self.vncInputParameter)
        DialogRealVNC.setTabOrder(self.vncInputParameter, self.vncInputAutostart)
        DialogRealVNC.setTabOrder(self.vncInputAutostart, self.vncInputRepeat)
        DialogRealVNC.setTabOrder(self.vncInputRepeat, self.vncInputAlternative)
        DialogRealVNC.setTabOrder(self.vncInputAlternative, self.vncInputIcon)
        DialogRealVNC.setTabOrder(self.vncInputIcon, self.vncInputIconName)
        DialogRealVNC.setTabOrder(self.vncInputIconName, self.vncOKButton)
        DialogRealVNC.setTabOrder(self.vncOKButton, self.vncCancelButton)
        DialogRealVNC.setTabOrder(self.vncCancelButton, DialogRealVNC.vncInputName_2)
        DialogRealVNC.setTabOrder(DialogRealVNC.vncInputName_2, DialogRealVNC.vncInputAddress_2)
        DialogRealVNC.setTabOrder(DialogRealVNC.vncInputAddress_2, DialogRealVNC.vncInputPort_2)
        DialogRealVNC.setTabOrder(DialogRealVNC.vncInputPort_2, DialogRealVNC.vncInputPassword_2)
        DialogRealVNC.setTabOrder(DialogRealVNC.vncInputPassword_2, DialogRealVNC.vncInputResolution_2)
        DialogRealVNC.setTabOrder(DialogRealVNC.vncInputResolution_2, DialogRealVNC.vncInputColor_2)
        DialogRealVNC.setTabOrder(DialogRealVNC.vncInputColor_2, DialogRealVNC.vncInputParameter_2)
        DialogRealVNC.setTabOrder(DialogRealVNC.vncInputParameter_2, DialogRealVNC.vncInputAutostart_2)
        DialogRealVNC.setTabOrder(DialogRealVNC.vncInputAutostart_2, DialogRealVNC.vncInputRepeat_2)
        DialogRealVNC.setTabOrder(DialogRealVNC.vncInputRepeat_2, DialogRealVNC.vncInputAlternative_2)
    ...
    def retranslateUi(self, DialogRealVNC):
        ...
        self.vncInputIcon.setText(_translate("DialogRealVNC", "Symbol erstellen"))
        self.vncLabelIconName.setText(_translate("DialogRealVNC", "Bezeichnung Symbol"))
