...
class dialogRealVNCUI(QtWidgets.QDialog, dialogrealvncui.Ui_DialogRealVNC):
    ...
    def __init__(self, name, configfile):
        ...
        self.setWindowTitle(common.getRessource("RealVNCViewerDialogTitle"))
        ...
        common.fillComboBox(self, "RealVNCViewerColorLevel", self.vncInputColor)
    ...
    def parameterVNC(self, connectionname, values):
        ...
        if values["password"] != "":
            parameters = parameters + " " + common.getRessource("RealVNCViewerPassword") + " " + common.getPasswordFile(connectionname)

        if values["resolution"] == "FullScreen":
            parameters = parameters + " " + common.getRessource("RealVNCViewerFullScreen")
        else:
            parameters = parameters + " " + common.getRessource("RealVNCViewerScreen") + " " + values["resolution"]
        if values["color"] == "FullColor":
            parameters = parameters + " " + common.getRessource("RealVNCViewerFullColor")
        else:
            parameters = parameters + " " + common.getRessource("RealVNCViewerColor") + " " + values["color"]
        if values["parameter"] != "":
